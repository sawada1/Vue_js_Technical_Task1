    ...
    >
      <div>
        <div class="flex items-center gap-3">
          <p
            class="mb-1 text-sm font-semibold uppercase tracking-[0.3em] text-brand-600"
          >
            Tasks
          </p>
          <span
        ...
        <h1 class="text-2xl font-bold text-slate-900">
          Tasks table (API test)
        </h1>
        <p class="mt-1 text-sm text-slate-600">
          Data fetched from mock API endpoint
      ...
      <div class="flex gap-2">
        <button
          @click="showForm = true"
          class="rounded-md bg-brand-600 px-3 py-2 text-sm font-medium text-white hover:bg-brand-500 flex items-center gap-2"
        >
          <svg
            class="w-4 h-4"
            fill="none"
